...
| 40 | `docs/tarinkot-air-operations-baseline` | PR 38 | Tarinkot / Camp Holland Air-Operations-Baseline und post-periodische Satellitenbildauswertung | Dokumente 11/19, Tarinkot-Evidenz, Evidenzindex und Unterprojektregister | `DRAFT`; aktive Tarinkot-Projektentscheidung auf gemischter In-Period-/Post-Period-Evidenz | keine DCS-/MOOSE-Runtime-Acceptance; Parking, Warehouse und Rampenbelegung noch zu validieren | offen | Foundation-Build-Vorgabe für Tarinkot; Parent-Pool-Abzug von Kandahar zwingend |
