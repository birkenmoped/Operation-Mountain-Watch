...
`AAR-KC135-RUNTIME-ACCEPTANCE-3` verwendet nur Clancy und Nelson als Funk-/TACAN-Exemplare, verlegt die Gate-Kandidaten weiter an den Kartenrand und nutzt den bestehenden Bagram-F-16C-AIRWING-/SQUADRON-/Payload-Pfad für einen KI-Boom-Test. Es wird kein neues Mission-Editor-Template erzeugt und keine `.miz` automatisiert verändert.
