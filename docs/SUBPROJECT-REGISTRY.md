...
| 38 | `docs/afghanistan-force-aviation-source-consolidation` | `main` | Konsolidierung Afghanistan-Kräfte, Basen, Aviation, USMC RC-Southwest, Army-Aviation-Vignetten, Carlisle-Quellenkritik, Air Tasking/Airspace/CAS Requests, monatliche Koalitions-ORBAT und RED-Commander-Verhalten | Dokumente 50–56; Dokumente 05/09/11/13/18/29/37/45/49; Register, Index, Quellenaufnahme-Audit und externe Quellenakten | `DRAFT`; quellenqualifizierte historische, Air-C2- und RED-Verhaltensreferenzen | Dokumentationsvalidator erfolgreich auf Head `985782587bd1155ee9226a507caa8c798278957f`; keine DCS-/MOOSE-Runtime-Acceptance | 40 | Forschungs-, Missionsdesign- und Datenmodellgrundlage; aktive ORBAT bleibt Dokument 19 |
| 40 | `docs/tarinkot-air-operations-baseline` | PR 38 | Tarinkot / Camp Holland Air-Operations-Baseline, Missionseditor-Audit und Implementierungsvertrag | Dokumente 11/19, `tarinkot-air-operations-manifest.md`, Tarinkot-Satelliten- und `.miz`-Evidenz, Evidenzindex und Unterprojektregister | `DRAFT`; verbindliche Tarinkot-Projektentscheidung und technisches Manifest | `OMW_Template(3).miz` strukturell auditiert; Warehouse-Anker, Clients, Statics und Seeds bestätigt; keine DCS-/MOOSE-Runtime-Acceptance; Safe Parking, Zonen, AIRWING, AUFTRAG sowie Verlust-/Rückgabeprüfung offen | offen | Foundation-Build- und Implementierungsvertrag für Tarinkot; Parent-Pool-Abzug von Kandahar zwingend |
