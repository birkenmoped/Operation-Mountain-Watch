...
if not cfg then
  ...
  ph1.Tests = {
    OH58D_RECON = {
      Id = "OH58D_RECON",
      Label = "OH-58D Two-Ship RECON",
      SquadronKey = "OH58D",
      PayloadKey = "OH58DRecon",
      ExpectedType = "OH58D",
      ExpectedGroups = 1,
      ExpectedAircraft = 2,
      MissionType = "RECON",
    ...
    UH60_TROOP = {
      Id = "UH60_TROOP",
      Label = "UH-60A Single-Ship TROOPTRANSPORT",
      SquadronKey = "UH60",
      PayloadKey = "UH60MedevacLead",
      ExpectedType = "UH-60A",
      ExpectedGroups = 1,
      ExpectedAircraft = 1,
      MissionType = "TROOPTRANSPORT",
      Timeout = 2100,
      RequireEngineStart = true,
      RequireTakeoff = true,
      RequireExecution = true,
    ...
    CH47_CARGO = {
      Id = "CH47_CARGO",
      Label = "CH-47F Single-Ship CARGOTRANSPORT",
      SquadronKey = "CH47",
      PayloadKey = "CH47HeavyLift",
      ExpectedType = "CH-47Fbl1",
      ExpectedGroups = 1,
      ExpectedAircraft = 1,
      MissionType = "CARGOTRANSPORT",
      Timeout = 2400,
      RequireEngineStart = true,
      RequireTakeoff = true,
      RequireExecution = true,
    ...
    UH60_ABORT = {
      Id = "UH60_ABORT",
      Label = "UH-60A Spawn/Reservation Abort",
      SquadronKey = "UH60",
      PayloadKey = "UH60MedevacLead",
      ExpectedType = "UH-60A",
      ExpectedGroups = 1,
      ...
      Timeout = 900,
      AbortOnBirth = true,
      RequireEngineStart = false,
      RequireTakeoff = false,
  ...
  log("READY version=" .. ph1.Version .. " tests=5 sequence=OH58D_RECON>AH64D_CAS>UH60_TROOP>CH47_CARGO>UH60_ABORT")
end
