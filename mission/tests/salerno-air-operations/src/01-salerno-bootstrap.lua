...
OMW.AirOps.SalernoDiagnostics = {
  Version = "SAL-DISPATCH-READINESS-7",
...
log("STAGED_TEST=true AIRWING_CONSTRUCT=true SQUADRON_CONSTRUCT=true SQUADRON_REGISTRATION=true SQUADRON_CONFIG=true MISSION_CAPABILITIES=true PAYLOADS=true AIRWING_START=true DISPATCH_READINESS=true MISSIONS=false spawn=false mutation=true")
