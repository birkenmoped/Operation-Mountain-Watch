...
Write-Host 'ExternalArtyMode: MOOSE COMMANDER -> ARTY-only descriptor PLATOON/BRIGADE reservation -> exact existing Functional ARTY owner; no AUFTRAG FireAtPoint owner'
