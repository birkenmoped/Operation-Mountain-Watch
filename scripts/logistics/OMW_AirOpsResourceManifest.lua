...
local entries = {
  ...
  },
  {
    ...
    reconciliationEligible = false,
    mappingScope = "UNVALIDATED_RUNTIME_MAPPING_CANDIDATE",
    returnSemantics = "UNVALIDATED_FOR_STRIKE_VARIANT",
  },
  {
  ...
  },
  {
    ...
    storageKind = nil,
    reconciliationEligible = false,
    mappingScope = "UNRESOLVED_F16_DEPLOYMENT_ITEM",
    returnSemantics = "STRATEGIC_STOCK_FINAL_RUNTIME_MAPPING_UNVALIDATED",
  },
  {
    key = "F15E_AAQ13",
