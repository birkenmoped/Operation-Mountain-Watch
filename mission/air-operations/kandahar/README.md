...
Before any airport-specific work, the successor chat must read the authority on `main`, inspect this integration branch and inventory all existing documentation and branches for the selected airport. Working methods and agreements are taken from repository documentation, not reconstructed from chat memory.
