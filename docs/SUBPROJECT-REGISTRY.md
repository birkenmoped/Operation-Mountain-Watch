...
| 38 | `docs/afghanistan-force-aviation-source-consolidation` | `main` | Konsolidierung Afghanistan-Kräfte, Basen, Aviation, USMC RC-Southwest und Koalitionsoperationen | Dokumente 50/51, Dokumente 05/09/11/13/18 sowie Register/Index/Evidenz | `DRAFT`; neue historische Referenzen | Dokumentations-CI nach aktuellem Head zu prüfen; keine DCS-/MOOSE-Runtime-Acceptance | offen | quellenqualifizierte Forschungs- und Designgrundlage; aktive ORBAT bleibt Dokument 19 |
