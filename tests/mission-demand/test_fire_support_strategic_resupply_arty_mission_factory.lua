...
eq(mission._omwFssrArtyTarget.coordinate,targetCoordinate,"selection target metadata coordinate")
eq(mission._omwFssrArtyTarget.shots,4,"selection target metadata shots")
eq(mission._omwFssrArtyTarget.radiusM,75,"selection target metadata radius")
