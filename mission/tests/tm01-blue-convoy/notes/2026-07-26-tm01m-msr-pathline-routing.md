...
Datum: 26. Juli 2026  
Status: `30-km/h-Baseline DCS PASS`; aktuelles Folgeinkrement siehe `2026-07-26-tm01m-five-convoy-50kph-test.md`
...
Der vollständige DCS-Lauf bestand mit sechs überlebenden Fahrzeugen. Ergebnisbericht:
...
Die Einzelkonvoi-Basis wird nun zu fünf gleichzeitigen Konvois bei 50 km/h erweitert. Die technische und missionsbezogene Beschreibung liegt unter:

```text
mission/tests/tm01-blue-convoy/notes/2026-07-26-tm01m-five-convoy-50kph-test.md
```

Die aktuelle Abnahmeanweisung liegt unter:

```text
mission/tests/tm01-blue-convoy/expected/tm01m-moose-native-physical-acceptance.md
```
