...
| 38 | `docs/afghanistan-force-aviation-source-consolidation` | `main` | Konsolidierung Afghanistan-Kräfte, Basen, Aviation, USMC RC-Southwest, Army-Aviation-Vignetten, Carlisle-Quellenkritik sowie Air Tasking/Airspace/CAS Requests | Dokumente 50–54; Dokumente 05/09/11/13/18/29/45/49; Register, Index, Quellenaufnahme-Audit und externe Quellenakten | `DRAFT`; quellenqualifizierte historische und Air-C2-Referenzen | Dokumentationsvalidierung erfolgreich; keine DCS-/MOOSE-Runtime-Acceptance | offen | Forschungs-, Missionsdesign- und Datenmodellgrundlage; aktive ORBAT bleibt Dokument 19 |
