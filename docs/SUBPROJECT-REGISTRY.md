...
| 38 | `docs/afghanistan-force-aviation-source-consolidation` | `main` | Konsolidierung Afghanistan-Kräfte, Basen, Aviation, USMC RC-Southwest, Army-Aviation-Vignetten und Koalitionsoperationen | Dokumente 50/51/52, Dokumente 05/09/11/13/18 sowie Register/Index/Evidenz und externe Quellenakten | `DRAFT`; neue historische Referenzen | Dokumentationsvalidierung für Head `7532aec055f03f2f1d19aab2bedd5dc7e7c03d36` erfolgreich; keine DCS-/MOOSE-Runtime-Acceptance | offen | quellenqualifizierte Forschungs- und Designgrundlage; aktive ORBAT bleibt Dokument 19 |
