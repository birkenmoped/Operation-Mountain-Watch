...
$version='OMW-FIRE-SUPPORT-STRATEGIC-RESUPPLY-PRODUCTION-BASE-ACCEPTANCE-3-3'
...
$c=$p+"`n"+$t
foreach($m in @('OMW-FIRE-SUPPORT-STRATEGIC-RESUPPLY-RUNTIME-8','OMW-FIRE-SUPPORT-STRATEGIC-RESUPPLY-PERIMETER-RUNTIME-2','OMW-FOB-THREAT-OPSZONE-ADAPTER-5','StartPerimeters','PROXIMITY_INTRUSION','OMW_BLUE_OBJECTIVE_JALALABAD_AIRPORT','BadGuys_A3_FENTY','BadGuys_A3_FORTRESS','BadGuys_A3_JOYCE','BadGuys_A3_WRIGHT','BadGuys_A3_HONAKER','BadGuys_A3_BOSTICK','RouteGroundTo','GROUP.Attribute.GROUND_INFANTRY','GROUP.Attribute.GROUND_APC')){if(-not $c.Contains($m)){throw "Acceptance 3 marker missing: $m"}}
foreach($radius in @('1828.8','1524.0','2743.2','1219.2')){if(-not $c.Contains($radius)){throw "Acceptance 3 owner-defined radius marker missing: $radius"}}
...
$header="-- AUTO-GENERATED FILE. DO NOT EDIT DIRECTLY.`n-- BuilderVersion: $version`n-- GitCommit: $commit`n-- MOOSE release: 2.9.18`n-- MOOSE commit: 73d3ed119cd9e7e3f2cfcabbaa34513d30529b54`n-- Moose.lua SHA-256: E3B750921EE22CFB37DD1CEC7549831A9165FFE64CD26BE154B49E63E001A915`n-- Acceptance-only six-site owner-defined alarm geometry and physical MOOSE OPSZONE qualification.`n`n"
...
Write-Host 'JalalabadAlarmZoneSource: existing MOOSE ZONE OMW_BLUE_OBJECTIVE_JALALABAD_AIRPORT'
