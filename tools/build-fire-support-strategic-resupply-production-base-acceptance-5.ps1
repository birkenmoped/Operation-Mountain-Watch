...
$version='OMW-FIRE-SUPPORT-STRATEGIC-RESUPPLY-PRODUCTION-BASE-ACCEPTANCE-5-1'
...
if($p -match 'guardRouteAdapter=GuardRouteAdapter'){throw 'Production incident-local Guard runtime must not install the historical Guard route adapter.'}
