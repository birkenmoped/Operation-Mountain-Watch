...
Die Owner-Freigabe vom 2026-08-29 erlaubt ausschließlich die dort präzise begrenzte interne `Asset.Treturned`-Ausnahme für einen user-abgebrochenen, bereits gespawnten, aber niemals airborne gewesenen UAV-Flug. Sie ersetzt weder MOOSE-Queueing noch strategische Ressourcenbindung und ist weder eine allgemeine Produktionsfreigabe noch ein DCS-Acceptance-Nachweis. Details, Quellenprüfung und die verbindlichen Guardrails: [OMW-UAV-ISR-REQUEST-MAIN-RECONCILIATION](../91-uav-isr-request-orchestration.md).
