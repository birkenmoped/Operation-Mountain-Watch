...
$builderVersion = 'STAGE3-HONAKER-WRIGHT-FULL-RESPONSE-ACCEPTANCE-1-25'
...
$requiredMarkers = @(
  ...
  'OMW-HELICOPTER-CAS-TACTICAL-CORRIDOR-1','PlanRouteGated','CAS_ROUTE_GATES_DERIVED','SetMissionIngressCoord','SetMissionWaypointCoord','SetMissionEgressCoord','CAS_GEOMETRY_CONFIGURED','requireRawCoordinate','requireHeadingDegrees','cycleKey',
...
foreach ($marker in @(
  ...
  'speedKts = CAS_SPEED_KTS','routeGateDistanceNm = 3.5','CasTacticalCorridor.PlanRouteGated','CasTacticalCorridor.ConfigureMission','CasTacticalCorridor.Bind','CAS_CONTEXT_EXCEPTION_ISOLATED','CAS_DISPATCH_EXCEPTION_ISOLATED','dispatchFollowOnFire','FIRE_SUPPORT_REARMED_CONTINUATION','Fresh C2 contact after local rearm',
