...
$output = Join-Path $outDir 'OMW_UAV_ISR_Request_Acceptance_2.lua'
...
$parts.Add('-- Generated by tools/build-uav-isr-request-acceptance-2.ps1')
...
foreach ($relative in $sources) {
  ...
  foreach ($pattern in $forbidden) {
    ...
    $name = switch -Wildcard ($relative) {
      ...
      '*02-uav-isr-request-acceptance-2.lua' { 'Acceptance' }
...
Write-Output 'BuilderVersion: OMW-UAV-ISR-REQUEST-ACCEPTANCE-2-2'
