...
| `WAREHOUSE.Assetitem.Treturned` | `INTERNAL_RESTRICTED / SOURCE_REVIEWED_EXCEPTION_APPROVED_DCS_PENDING` | Keine öffentliche MOOSE-API für eine Einzelasset-Turnover-Ausnahme gefunden. Der Owner hat am 2026-08-29 ausschließlich den Ground-Recall-Fall eines eindeutig gebundenen, nie airborne gewesenen UAV freigegeben; kein Queue-, Binding-, Return-, Loss- oder allgemeiner Turnover-Override. |
