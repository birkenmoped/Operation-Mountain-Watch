...
$builderVersion='OMW-FIRE-SUPPORT-STRATEGIC-RESUPPLY-PRODUCTION-BASE-ACCEPTANCE-2-1'
...
-- Scope: production package installation incident + MOOSE-selected local QRF + incident refresh dedupe.
