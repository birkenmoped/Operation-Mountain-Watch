...
| 56 | `OMW-RED-INSURGENT-FACTIONS-BEHAVIOR` | `docs/56-insurgent-factions-shadow-governance-and-red-commander-behavior.md` | `BINDING` | quellenbasiertes RED-Fraktions-, Schattenherrschafts- und Verhaltensmodell |
