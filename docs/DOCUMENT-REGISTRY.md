...
| `OMW-TEST-ARMY-GROUND-ACCEPTANCE-6` | `mission/tests/army-ground-foundation/ACCEPTANCE-6.md` | `DCS_PENDING`; combined Fenty/Joyce/Wright normal-return, partial-loss and damaged-return gate |
