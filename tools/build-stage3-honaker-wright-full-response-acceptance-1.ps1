...
$builderVersion = 'STAGE3-HONAKER-WRIGHT-FULL-RESPONSE-ACCEPTANCE-1-1'
...
-- Scope: Honaker attack -> own QRF + CAS + Wright L118 -> local M1083 rearm -> CampaignState AMMO reorder -> Jalalabad CH47 Air-AMMO -> Wright.
-- HelicopterRoute: OMW_FlightPath outbound AND return for CAS and Air-AMMO.
...
Write-Host 'CASRouteOutbound: OMW_FlightPath'
Write-Host 'CASRouteReturn: OMW_FlightPath'
