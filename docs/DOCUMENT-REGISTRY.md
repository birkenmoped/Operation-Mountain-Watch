...
| 90 | `OMW-PLAN-MISSION-DEMAND-RESUPPLY-CAS` | `docs/90-mission-demand-resupply-and-cas-orchestration-concept.md` | `PLANNED` | MissionDemand-Orchestrierung für Resupply und Immediate CAS |
